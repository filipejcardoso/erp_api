...
use App\Models\TiposContatos;
use App\Helpers\Rest;
use App\Helpers\Result;
use Response;
use Input;
//-------------------------------------------------
class TiposContatosController extends Controller
{
    public function index(Request $request){
        $rest = new Rest();
        $rest->model = 'App\Models\TiposContatos';
...
//-------------------------------------------------
    public function update(Request $request, $id){
        try
        {
            $recurso = TiposContatos::findOrFail($id);
            $newresource = $request->toarray();
