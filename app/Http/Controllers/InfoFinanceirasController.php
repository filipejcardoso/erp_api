...
use App\Models\InfoFinanceiras;
use App\Helpers\Rest;
use App\Helpers\Result;
use Response;
use Input;
//-------------------------------------------------
class InfoFinanceirasController extends Controller
{
    public function index(Request $request, $associado){
        try
        {
            ...
            $rest = new Rest();
            $rest->model = 'App\Models\InfoFinanceiras';
...
//-------------------------------------------------
    public function update(Request $request, $associado, $id){
        ...
        try
        {
            ...
            try
            {
                $recurso = InfoFinanceiras::findOrFail($id);
                ...
                {
                    throw new ModelNotFoundException('Info Financeira does not belongs to Associado');
                }
            }
