...
use App\Models\TiposAssociados;
use App\Helpers\Rest;
use App\Helpers\Result;
use Response;
use Input;
//-------------------------------------------------
class TiposAssociadosController extends Controller
{
    public function index(Request $request){
        $rest = new Rest();
        $rest->model = 'App\Models\TiposAssociados';
...
//-------------------------------------------------
    public function update(Request $request, $id){
        try
        {
            $recurso = TiposAssociados::findOrFail($id);
            $newresource = $request->toarray();
